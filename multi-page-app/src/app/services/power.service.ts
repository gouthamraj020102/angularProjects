...
import { Power } from '../powers/model/Power';
...
export class PowerService {
  ...
  getPowersByCharacter(name: string): Power[] {
    return this.allPowers[name] || [];
  }

  private readonly allPowers: { [key: string]: Power[] } = {
    'Ben Tennyson': [
      ...
      // { name: 'Diamondhead', imageUrl: 'https://e1.pxfuel.com/desktop-wallpaper/153/791/desktop-wallpaper-diamondhead-from-ben-10-r-hop-ben-10-diamondhead.jpg' },
      // { name: 'Stinkfly', imageUrl: 'https://wallpapercave.com/wp/wp10716882.jpg' },
      // { name: 'XLR8', imageUrl: 'https://wallpapercave.com/wp/wp6635441.jpg' },
